...
# ------------------------------ 4.endpoint
# ADVENCED
# Rate Limiting: Bir foydalanuvchi sekundiga 100 ta tranzaksiya 
# yuborib, serverni crash qilmasligi uchun



# ------------------------------ 5.endpoint
# ADVENCED
# Idempotency by redis: ya'ni button'ni 2 martta bosganda 
# 2ta transaction bo'lmasligi uchun



# ------------------------------ 6.endpoint
# ADVENCED
# PDF check generatsiya: checkni pdf ko'rinishda yuklab olishlik uchun 
