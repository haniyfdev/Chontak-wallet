...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("");
    const result = await login(`+998${phone}`, password);
    if (result.success) navigate("/dashboard");
    else setError(result.message);
  };

  const displayPhone = phone.replace(/(\d{2})(\d{3})(\d{2})(\d{2})/, "$1 $2 $3 $4");
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0A1A", display: "flex", alignItems: "center", justifyContent: "center", padding: "16px" }}>
      ...
      <div style={{ position: "relative", width: "100%", maxWidth: "960px", display: "flex", borderRadius: "24px", overflow: "hidden", border: "1px solid rgba(255,255,255,0.08)", boxShadow: "0 25px 80px rgba(0,0,0,0.6)", minHeight: "560px" }}>

        {/* Chap panel — katta logo */}
            ...
            <div style={{ position: "relative" }}>
              ...
              {/* Logo rasm */}
                ...
                <div style={{ 
                  ...
                  height: "360px", 
                  borderRadius: "50%", 
                  overflow: "hidden", // Ortiqcha qismini kesib tashlaydi
                  border: "3px solid rgba(139,92,246,0.3)", 
                  boxShadow: "0 0 60px rgba(139,92,246,0.3), 0 0 120px rgba(99,102,241,0.15)", 
                  flexShrink: 0,
                  position: "relative", // Ichidagi rasm absolute bo'lishi uchun
                  background: "rgba(0,0,0,0.1)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  background: "rgba(0,0,0,0.2)" // Markazni aniq ko'rish uchun
                }}>
              ...
              <img 
                ...
                style={{ 
                  ...
                  height: "100%", 
                  objectFit: "contain",
                  transform: "scale(1.8) translateY(4%)",  // translateY qo'shdik - pastga suradi
        ...
        <div style={{ flex: 1, background: "#0D0D22", borderLeft: "1px solid rgba(255,255,255,0.06)", padding: "48px 40px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <div style={{ marginBottom: "32px" }}>
            ...
            <h2 style={{ fontSize: "26px", fontWeight: 800, color: "white", marginBottom: "6px" }}>Xush kelibsiz 👋</h2>
            <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "14px" }}>Hisobingizga kirish uchun ma'lumotlarni kiriting</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type={showPass ? "text" : "password"} placeholder="Parolingizni kiriting" value={password}
                  onChange={e => setPassword(e.target.value)}
                  style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "14px", padding: "14px 42px", fontSize: "14px", color: "white", outline: "none", boxSizing: "border-box" }} />
